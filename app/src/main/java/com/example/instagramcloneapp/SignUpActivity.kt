...
class SignUpActivity : AppCompatActivity() {
    ...
    private fun saveUserInfo(fullName: String, userName: String, email: String, password: String, progressDialog: ProgressDialog) {
        ...
        userMap["minho"] = "hey my name is Lee Minho."
        userMap["image"] = "https://firebasestorage.googleapis.com/v0/b/instagram-clone-app-bc9c9.appspot.com/o/Default%20Images%2Fprofile.png?alt=media&token=fb3bfcee-10c6-47d2-b32d-186f9dc1d992"
